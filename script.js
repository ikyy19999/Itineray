document.addEventListener('DOMContentLoaded', function() {
    ...
    const setupSuggestionForm = (formId, dayName) => {
        ...
        form.addEventListener('submit', function(e) {
            e.preventDefault();
            const suggestion = document.getElementById(`suggestion${dayName}`).value.trim();
            
            if (suggestion) {
                // Replace with your actual WhatsApp number (format: country code + number without + or 0)
                const targetNumber = "YOUR_NUMBER"; // Example: Indonesia number
                
                const whatsappMessage = `*Suggestion for ${dayName}:*\n\n${suggestion}\n\n_Sent from Fairytale Journey Website_`;
    ...
    const photoCollections = {
        ...
        'Pasar Ngasem': [
            'assets/Pasar Ngasem.jpg',
            'assets/ngasem 2.webp'
        ],
        'Taman Sari': [
            'assets/Taman Sari.jpg',
            'assets/Taman Sari 2.jpg',
            'assets/Taman Sari 3.jpg',
            'assets/Taman Sari 4.jpg',
            'assets/Taman Sari 5.jpg',
            'assets/Taman Sari 6.jpg',
            'assets/Taman Sari 7.jpg',
            'assets/Taman Sari 8.jpg',
            'assets/Taman Sari 9.jpg',
            'assets/Taman Sari 10.jpg',
            'assets/Taman Sari 11.jpg',
            'assets/Taman Sari 12.mp4',
            'assets/Taman-Sari-13.mp4',
            'assets/Taman-Sari-14.mp4',
        ],
        'Yogyakarta Palace': [
            'assets/Keraton Yogyakarta.jpg',
        ],
        'Tempo Gelato': [
            'assets/Gelato.jpg',
        ],
        'PICTNIQ Land': [
            'assets/PICTNIQ.jpg',
            'assets/PICTNIQ 2.jpg',
            'assets/PICTNIQ 3.jpg',
            'assets/PICTNIQ 4.jpg',
            'assets/PICTNIQ 5.jpg',
            'assets/PICTNIQ 6.jpg',
            'assets/PICTNIQ 7.jpg',
            'assets/PICTNIQ 8.jpg',
            'assets/PICTNIQ 9.jpg',
            'assets/PICTNIQ 10.jpg',
            'assets/PICTNIQ 11.jpg',
            'assets/PICTNIQ 12.jpg',
            'assets/PICTNIQ 13.jpg',
            'assets/PICTNIQ 14.jpg',
            'assets/PICTNIQ 15.jpg',
            'assets/PICTNIQ 16.jpg',
            'assets/PICTNIQ 17.jpg',
            'assets/PICTNIQ 18.jpg',
            'assets/PICTNIQ 19.jpg',
            'assets/PICTNIQ 20.jpg',
            'assets/PICTNIQ 21.jpg',
            'assets/PICTNIQ 22.jpg',
            'assets/PICTNIQ 23.jpg',
            'assets/PICTNIQ 24.jpg',
            'assets/PICTNIQ 25.jpg',
            'assets/PICTNIQ 26.jpg',
            'assets/PICTNIQ 27.jpg',
            'assets/PICTNIQ 28.jpg',
            'assets/PICTNIQ 29.jpg',
            'assets/PICTNIQ 30.jpg',
            'assets/PICTNIQ 31.jpg',
        ],
        'Pasar Prawirotaman': [
            'assets/Pasar prawirotaman.jpg',
        ],
        'Malioboro Street': [
            'assets/Malioboro.jpg',
            'assets/Malioboro 2.jpg',
            'assets/Malioboro 3.mp4',
        ],
        'Pasar Beringharjo': [
            'assets/Pasar Beringharjo Yogyakarta.jpg',
        ],
        'Kano Maritim Baros': [
            'assets/KANO MARITIM BAROS.jpg',
        ],
        'The Rock Burger Timoho': [
            'assets/The Rock Burger Timoho.jpg',
            'assets/Burger.jpg',
            'assets/burger 2.jpg'
        ],
        'Jogja Heritage Track': [
            'assets/Tugu Jogja.jpg',
            'assets/Jogja Heritage 2.jpg',
            'assets/Jogja Heritage 3.jpg',
            'assets/Jogja Heritage 4.jpg',
            'assets/Jogja Heritage 5.jpg',
            'assets/Jogja Heritage 6.jpg',
            'assets/Jogja Heritage 7.jpg',
            'assets/Jogja Heritage 8.jpg',
            'assets/Jogja Heritage 9.jpg',
            'assets/Jogja Heritage 10.jpg',
            'assets/Jogja Heritage 11.jpg',
            'assets/Jogja Heritage 12.jpg',
        ],
        'L\'Union Pizza': [
            'assets/L\'Union Pizza.jpg',
        ]
    };
